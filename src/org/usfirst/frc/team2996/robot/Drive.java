...
public class Drive {
	// declare private variables to be used only in this class
	...
	public void invertMotors(boolean frontLeftMotorInvert, boolean frontRightMotorInvert, boolean backLeftMotorInvert, boolean backRightMotorInvert) { // method to invert drive motors if needed - takes booleans of the four drive motor controllers as parameters 
	...
	public void sebastianDrive() {
		...
		robotDrive.arcadeDrive( // robotDrive calls the method drive that takes a forward speed and a turning speed
